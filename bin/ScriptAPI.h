...
enum JoystickConnected
{
%JoystickID : int;
};
enum JoystickDisconnected
{
%JoystickID : int;
};
enum JoystickButtonDown
{
%JoystickID : int;
%Button : int;
};
enum JoystickButtonUp
{
%JoystickID : int;
%Button : int;
};
enum JoystickAxisMove
{
%JoystickID : int;
%Button : int;
%Position : float;
};
enum JoystickHatMove
{
%JoystickID : int;
%Button : int;
%Position : int;
...
enum MouseVisibleChanged
{
%Visible : bool;
};
enum MouseModeChanged
{
%Mode : MouseMode;
};
enum ExitRequested
...
enum NavigationMeshRebuilt
{
%Node : Node pointer;
%Mesh : NavigationMesh pointer;
};
enum NavigationAreaRebuilt
{
%BoundsMin : Vector3;
%BoundsMax : Vector3;
};
enum CrowdAgentReposition
{
%Position : Vector3;
%Velocity : Vector3;
};
enum CrowdAgentStateChanged
{
%Position : Vector3;
%Velocity : Vector3;
%State : int;
};
enum NavigationObstacleAdded
{
%Node : Node pointer;
%Position : Vector3;
%Radius : float;
...
enum NavigationObstacleRemoved
{
%Node : Node pointer;
%Position : Vector3;
%Radius : float;
...
enum ServerConnected
{
};
enum ServerDisconnected
{
};
enum ConnectFailed
{
...
enum NetworkUpdateSent
{
};
enum NetworkSceneLoadFailed
{
%Connection : Connection pointer;
};
enum RemoteEventData
{
%Connection : Connection pointer;
## %Physics2D events;
};
enum PhysicsPreStep2D
{
%World : PhysicsWorld2D pointer;
%TimeStep : float;
};
enum PhysicsPostStep2D
{
%World : PhysicsWorld2D pointer;
%TimeStep : float;
};
enum PhysicsBeginContact2D
{
%World : PhysicsWorld2D pointer;
...
enum PhysicsPostStep
{
%World : PhysicsWorld pointer;
%TimeStep : float;
};
enum PhysicsCollisionStart
{
%World : PhysicsWorld pointer;
%NodeA : Node pointer;
%NodeB : Node pointer;
...
enum UnknownResourceType
{
%ResourceType : StringHash;
};
enum ResourceBackgroundLoaded
{
%ResourceName : String;
%Success : bool;
...
enum SceneSubsystemUpdate
{
%Scene : Scene pointer;
%TimeStep : float;
};
enum UpdateSmoothing
{
%Constant : float;
%SquaredSnapThreshold : float;
};
enum SceneDrawableUpdateFinished
{
%Scene : Scene pointer;
%TimeStep : float;
};
enum TargetPositionChanged
{
};
enum TargetRotationChanged
{
};
enum AttributeAnimationUpdate
{
%Scene : Scene pointer;
%TimeStep : float;
};
enum AttributeAnimationAdded
{
%ObjectAnimation : Object animation pointer;
%AttributeAnimationName : String;
};
enum AttributeAnimationRemoved
{
%ObjectAnimation : Object animation pointer;
%AttributeAnimationName : String;
};
enum ScenePostUpdate
{
%Scene : Scene pointer;
%TimeStep : float;
};
enum AsyncLoadProgress
{
%Scene : Scene pointer;
%Progress : float;
%LoadedNodes : int;
...
enum ComponentRemoved
{
%Scene : Scene pointer;
%Node : Node pointer;
%Component : Component pointer;
};
enum NodeNameChanged
{
%Scene : Scene pointer;
%Node : Node pointer;
};
enum NodeEnabledChanged
{
%Scene : Scene pointer;
%Node : Node pointer;
};
enum ComponentEnabledChanged
{
%Scene : Scene pointer;
%Node : Node pointer;
%Component : Component pointer;
};
enum TemporaryChanged
{
%Serializable : Serializable pointer;
};
enum InterceptNetworkUpdate
{
%Serializable : Serializable pointer;
...
enum ConstraintGear2D
{
%Is %Enabled : bool;
%Ratio : float;
%Collide %Connected : bool;
};
enum ConstraintMotor2D
{
%Is %Enabled : bool;
...
<a href="#Class_Animation2D"><b>Animation2D</b></a>;
...
array<Variant> attributeDefaults // readonly;
array<AttributeInfo> attributeInfos // readonly;
...
array<AnimationState@> animationStates // readonly;
array<Variant> attributeDefaults // readonly;
array<AttributeInfo> attributeInfos // readonly;
array<Variant> attributes;
StringHash baseType // readonly;
...
uint maxLights;
Model@ model;
array<String> morphNames // readonly;
...
uint numTriggers;
int refs // readonly;
array<AnimationTriggerPoint@> triggers // readonly;
StringHash type // readonly;
String typeName // readonly;
uint useTimer // readonly;
int weakRefs // readonly;
<a name="Class_Animation2D"></a>;
};
class Animation2D
{
//Properties:;
float length // readonly;
bool looped // readonly;
...
array<String>@ enumNames // readonly;
uint mode;
String name;
VariantType type;
...
array<Variant> attributes;
StringHash baseType // readonly;
array<Billboard@> billboards // readonly;
BoundingBox boundingBox // readonly;
bool castShadows;
String category // readonly;
float drawDistance;
...
array<UIElement@> children // readonly;
IntRect clipBorder;
bool clipChildren;
...
array<String> historyRow // readonly;
...
uint numAttributes // readonly;
uint numGeometries;
array<uint> numVertices // readonly;
ObjectAnimation@ objectAnimation;
bool occludee;
bool occluder;
int refs // readonly;
...
int indentWidth // readonly;
bool internal;
array<UIElement@> items // readonly;
IntRect layoutBorder;
Vector2 layoutFlexScale;
LayoutMode layoutMode;
int layoutSpacing;
...
//Properties:;
array<Vector3> vertices // readonly;
...
StringHash type // readonly;
String typeName // readonly;
array<VertexBuffer@> vertexBuffers // readonly;
uint vertexCount // readonly;
array<uint> vertexElementMasks // readonly;
...
array<int>@ multiSampleLevels // readonly;
...
array<IntVector2>@ resolutions // readonly;
bool sRGB;
...
String category // readonly;
bool focus // readonly;
array<JoystickState@> joysticks // readonly;
array<JoystickState@> joysticksByIndex // readonly;
array<bool> keyDown // readonly;
array<bool> keyPress // readonly;
bool minimized // readonly;
array<bool> mouseButtonDown // readonly;
array<bool> mouseButtonPress // readonly;
bool mouseGrabbed;
MouseMode mouseMode;
...
array<bool> qualifierDown // readonly;
array<bool> qualifierPress // readonly;
int qualifiers // readonly;
int refs // readonly;
array<bool> scancodeDown // readonly;
array<bool> scancodePress // readonly;
array<bool> screenJoystickVisible;
bool screenKeyboardSupport // readonly;
bool screenKeyboardVisible;
bool toggleFullscreen;
bool touchEmulation;
array<TouchState@> touches // readonly;
StringHash type // readonly;
String typeName // readonly;
int weakRefs // readonly;
...
{
//Properties:;
array<float> axisPosition // readonly;
array<bool> buttonDown // readonly;
array<bool> buttonPress // readonly;
bool controller // readonly;
array<int> hatPosition // readonly;
int joystickID;
String name;
...
bool selected;
UIElement@ selectedItem // readonly;
array<UIElement@>@ selectedItems // readonly;
uint selection;
array<uint>@ selections // readonly;
IntVector2 size;
bool sortChildren;
String style;
bool temporary;
...
int refs // readonly;
Scene@ scene;
array<String>@ shaderParameterNames // readonly;
array<Variant> shaderParameters;
CullMode shadowCullMode;
array<TechniqueEntry> techniqueEntries // readonly;
array<Technique@> techniques // readonly;
...
StringHash baseType // readonly;
String category // readonly;
array<Connection@>@ clientConnections // readonly;
...
StringHash baseType // readonly;
String category // readonly;
array<Node@> children // readonly;
array<Component@> components // readonly;
Vector3 direction;
bool enabled;
bool enabledSelf // readonly;
uint id // readonly;
...
void SendEvent(const String&, VariantMap& = VariantMap ( ));
//Properties:;
array<Variant> attributeAnimations // readonly;
StringHash baseType // readonly;
String category // readonly;
uint memoryUse // readonly;
String name;
int refs // readonly;
array<Variant> speeds // readonly;
StringHash type // readonly;
String typeName // readonly;
uint useTimer // readonly;
int weakRefs // readonly;
array<Variant> wrapModes // readonly;
...
uint numBatches // readonly;
array<uint> numGeometries // readonly;
array<uint> numLights // readonly;
array<uint> numOccluders // readonly;
uint numPrimitives // readonly;
array<uint> numShadowMaps // readonly;
uint numViewports;
...
array<uint> memoryUse // readonly;
uint numBackgroundLoadResources // readonly;
array<PackageFile@>@ packageFiles // readonly;
int refs // readonly;
array<String>@ resourceDirs // readonly;
...
array<RigidBody@>@ collidingBodies // readonly;
...
Vector2 position2D;
int refs // readonly;
array<PackageFile@>@ requiredPackageFiles // readonly;
Vector3 right // readonly;
Quaternion rotation;
float rotation2D;
Vector3 scale;
...
uint id // readonly;
bool inView // readonly;
array<Node@> instanceNodes // readonly;
uint lightMask;
float lodBias;
Material@ material // writeonly;
array<Material@> materials;
...
array<String>@ passNames // readonly;
array<Pass@>@ passes // readonly;
int refs // readonly;
...
bool occluder;
int patchSize;
array<TerrainPatch@> patches // readonly;
int refs // readonly;
float shadowDistance;
uint shadowMask;
bool smoothing;
...
bool bringToFront;
String category // readonly;
array<IntVector2> charPositions // readonly;
array<IntVector2> charSizes // readonly;
IntVector2 childOffset // readonly;
array<UIElement@> children // readonly;
IntRect clipBorder;
bool clipChildren;
...
int height // readonly;
array<int> levelHeight // readonly;
array<int> levelWidth // readonly;
...
String name;
int refs // readonly;
array<RenderSurface@> renderSurfaces // readonly;
bool sRGB;
StringHash type // readonly;
String typeName // readonly;
TextureUsage usage // readonly;
...
//Properties:;
array<StringHash>@ keys // readonly;
uint length // readonly;
array<Variant>@ values // readonly;
...
class CrowdAgentState
{
NAV_AGENT_INVALID;
NAV_AGENT_READY;
NAV_AGENT_TRAVERSINGLINK;
};
class CrowdTargetState
{
...
class RenderCommandSortMode
{
SORT_FRONTTOBACK;
SORT_BACKTOFRONT;
};
class RenderCommandType
{
CMD_NONE;
CMD_CLEAR;
CMD_SCENEPASS;
...
class RenderSurfaceUpdateMode
{
SURFACE_MANUALUPDATE;
SURFACE_UPDATEVISIBLE;
SURFACE_UPDATEALWAYS;
};
class RenderTargetSizeMode
{
SIZE_ABSOLUTE;
